...
import { IonCheckbox, IonButton, IonInput } from "@ionic/angular/standalone";
...
@Component({
  ...
  imports: [DropdownComponent, FormsModule, FileUploadComponent, FileDownloadComponent, TimeDisplayComponent, IonButton, IonInput],
})
